...
#import "UILabel+ALAutoSize.h"

@implementation UILabel (ALAutoSize)
-(UILabel *)AL_resizeLabelHorizontal{
    return [self AL_resizeLabelHorizontal:0];
}

- (UILabel *)AL_resizeLabelVertical{
    return [self AL_resizeLabelVertical:0];
}

- (UILabel *)AL_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)AL_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
