...
#import "UIImageView+ALAddition.h"

@implementation UIImageView (ALAddition)
...
+ (id)AL_imageViewWithImageArray:(NSArray *)imageArray duration:(NSTimeInterval)duration;
{
    ...
    UIImageView *imageView = [UIImageView AL_imageViewWithImageNamed:[imageArray objectAtIndex:0]];
