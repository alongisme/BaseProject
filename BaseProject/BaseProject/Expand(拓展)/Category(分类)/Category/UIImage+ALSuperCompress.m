...
#import "UIImage+ALSuperCompress.h"

@implementation UIImage (ALSuperCompress)
...
+ (NSData *)AL_compressImage:(UIImage *)image toMaxLength:(NSInteger)maxLength maxWidth:(NSInteger)maxWidth{
    ...
    CGSize newSize = [self AL_scaleImage:image withLength:maxWidth];
    UIImage *newImage = [self AL_resizeImage:image withNewSize:newSize];
